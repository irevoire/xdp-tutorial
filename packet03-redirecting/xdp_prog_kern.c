...
int xdp_redirect_func(struct xdp_md *ctx)
{
	...
	// unsigned char dst[ETH_ALEN] = {0xee, 0x06, 0xc5, 0x24, 0xbc, 0x14};	/* Assignment 2: fill in with the MAC address of the left inner interface */
	unsigned ifindex = 10;		/* Assignment 2: fill in with the ifindex of the left interface */
